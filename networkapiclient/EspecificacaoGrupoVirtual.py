...
class EspecificacaoGrupoVirtual(object):
    ...
    def add_equipamento(self, id_tipo_equipamento, id_modelo, prefixo, id_grupo, id_vlan, descricao_vlan):
        ...
        equipamento_map['ip'] = {'id_vlan':id_vlan,'descricao':descricao_vlan}
    ...
    def add_vip(self, id, real_name_sufixo, id_vlan, descricao_vlan, id_vlan_real, descricao_vlan_real, 
                balanceadores, id_healthcheck_expect, finalidade, cliente, ambiente, cache, metodo_bal, 
                persistencia, healthcheck_type, healthcheck, timeout, host, maxcon, dsr, bal_ativo,
                transbordos, portas, real_maps, id_requisicao_vip,
                areanegocio='Orquestra', nome_servico='Orquestra', 
                l7_filter=None, reals_prioritys=None, reals_weights=None):
