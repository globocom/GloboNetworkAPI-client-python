...
class ApiV4IPv6(ApiGenericClient):
    ...
    def get(self, ids, **kwargs):
        ...
        return super(ApiV4IPv6, self).get(self.prepare_url(url, kwargs))
    ...
    def update(self, ipv6s):
        ...
        return super(ApiV4IPv6, self).put('api/v4/ipv6/%s/' %
                                          ';'.join(ipv6s_ids), data)
