...
class TipoRede(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(TipoRede, self).__init__(networkapi_url, user, password, user_ldap);
    ...
    def inserir(self, name):
        ...
        code, xml = self.submit({'net_type': net_type_map}, 'POST', 'net_type/')
    ...
    def alterar(self, id_net_type, name):
        ...
        if not is_valid_int_param(id_net_type):
            raise InvalidParameterError(u'Network type is invalid or was not informed.')
