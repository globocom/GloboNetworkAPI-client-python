...
class UsuarioGrupo(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(UsuarioGrupo, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def inserir(self, id_user, id_group):
        ...
        if not is_valid_int_param(id_group):
            raise InvalidParameterError(u'The identifier of Group is invalid or was not informed.')
        
        url = 'usergroup/user/' + str(id_user) + '/ugroup/' + str(id_group) + '/associate/'
    ...
    def remover(self, id_user, id_group):
        ...
        url = 'usergroup/user/' + str(id_user) + '/ugroup/' + str(id_group) + '/dissociate/'
