...
class EquipamentoAcesso(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(EquipamentoAcesso, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def list_by_equip(self,name):
        ...
        code, xml = self.submit({"equipamento_acesso":equip_access_map}, 'POST', 'equipamentoacesso/name/')
    ...
    def inserir(self, id_equipamento, fqdn, user, password, id_tipo_acesso, enable_pass):
        ...
        code, xml = self.submit({'equipamento_acesso':equipamento_acesso_map}, 'POST', 'equipamentoacesso/')
    ...
    def edit_by_id(self,id_equip_acesso,id_tipo_acesso, fqdn, user, password, enable_pass):
        ...
        if not is_valid_int_param(id_tipo_acesso):
            raise InvalidParameterError(u'Access type id is invalid or not informed.')
        ...
        code, xml = self.submit({'equipamento_acesso':equipamento_acesso_map}, 'POST', url)
    ...
    def remover(self, id_tipo_acesso, id_equipamento):
        ...
        url = 'equipamentoacesso/' + str(id_equipamento) + '/' + str(id_tipo_acesso) + '/'
