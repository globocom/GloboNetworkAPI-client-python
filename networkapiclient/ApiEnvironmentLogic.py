...
class ApiLogicEnvironment(ApiGenericClient):
    ...
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        super(ApiLogicEnvironment, self).__init__(
            networkapi_url,
            user,
            password,
            user_ldap
    ...
    def get(self, ids=None, **kwargs):
        ...
        """
        url = build_uri_with_ids('api/v3/environment/logic/', ids)
        return super(ApiLogicEnvironment, self).get(self.prepare_url(url, kwargs))
