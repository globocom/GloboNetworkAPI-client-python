...
class AmbienteLogico(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(AmbienteLogico, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def inserir(self, name):
        ...
        code, xml = self.submit({'logical_environment':logical_environment_map}, 'POST', 'logicalenvironment/')
    ...
    def alterar(self, id_logicalenvironment, name):
        ...
        if not is_valid_int_param(id_logicalenvironment):
            raise InvalidParameterError(u'The identifier of Logical Environment is invalid or was not informed.')
        ...
        code, xml = self.submit({'logical_environment':logical_environment_map}, 'PUT', url)
