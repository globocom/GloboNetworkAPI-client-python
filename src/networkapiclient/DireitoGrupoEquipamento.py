...
class DireitoGrupoEquipamento(GenericClient):
    ...
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(DireitoGrupoEquipamento, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def listar_por_grupo_usuario(self, id_grupo_usuario):
        ...
        if not is_valid_int_param(id_grupo_usuario):
            raise InvalidParameterError(u'O identificador do grupo de usuário é inválido ou não foi informado.')
    ...
    def buscar_por_id(self, id_direito):
        ...
        if not is_valid_int_param(id_direito):
            raise InvalidParameterError(u'O identificador do direito grupo equipamento é inválido ou não foi informado.')
    ...
    def inserir(self, id_grupo_usuario, id_grupo_equipamento, leitura, escrita, alterar_config, exclusao):
        ...
        code, xml = self.submit({'direito_grupo_equipamento':direito_map}, 'POST', 'direitosgrupoequipamento/')
    ...
    def alterar(self, id_direito, leitura, escrita, alterar_config, exclusao):
        ...
        code, xml = self.submit({'direito_grupo_equipamento':direito_map}, 'PUT', url)
