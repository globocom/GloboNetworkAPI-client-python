...
class PermissaoAdministrativa(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(PermissaoAdministrativa, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def list_by_group(self, id_ugroup):
        ...
        if id_ugroup is None:
            raise InvalidParameterError(u'The identifier of Group User is invalid or was not informed.') 
    ...
    def search(self, id_perm):
        ...
        if not is_valid_int_param(id_perm):
            raise InvalidParameterError(u'The identifier of Administrative Permission is invalid or was not informed.')
    ...
    def inserir(self, id_permission, read, write, id_group):
        ...
        code, xml = self.submit({'administrative_permission':perms_map}, 'POST', 'aperms/')
    ...
    def alterar(self, id_perm, id_permission, read, write, id_group):
        ...
        code, xml = self.submit({'administrative_permission':perms_map}, 'PUT', url)
