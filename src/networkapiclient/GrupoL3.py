...
class GrupoL3(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(GrupoL3, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def alterar(self, id_groupl3, name):
        ...
        if not is_valid_int_param(id_groupl3):
            raise InvalidParameterError(u'The identifier of Group L3 is invalid or was not informed.')
