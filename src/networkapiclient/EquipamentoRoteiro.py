...
class EquipamentoRoteiro(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(EquipamentoRoteiro, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def list_by_equip(self, name):
        ...
        code, xml = self.submit({"equipamento_roteiro":equip_script_map}, 'POST', 'equipamentoroteiro/name/')
    ...
    def remover(self, id_equipment, id_script):
        ...
        url = 'equipmentscript/' + str(id_equipment) + '/' + str(id_script) + '/'
