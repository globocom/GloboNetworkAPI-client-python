...
class OptionVIP(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(OptionVIP, self).__init__(networkapi_url, user, password, user_ldap);
    ...
    def add(self, tipo_opcao, nome_opcao_txt):
        ...
        code, xml = self.submit({'option_vip':optionvip_map}, 'POST', 'optionvip/')
    ...
    def buscar_rules(self, id_ambiente_vip, id_vip = ''):
        ...
        url = 'environment-vip/get/rules/' + str(id_ambiente_vip) + '/' + str(id_vip)
