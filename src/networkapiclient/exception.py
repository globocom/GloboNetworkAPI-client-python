...
class UserNotAuthenticatedError(NetworkAPIClientError):
    ...
    def __init__(self, error):
        NetworkAPIClientError.__init__(self, u'Usuário não autenticado. Usuário e/ou senha incorretos.')

class UserNotAuthorizedError(NetworkAPIClientError):
    
    def __init__(self, error):
        NetworkAPIClientError.__init__(self, u'Usuário não autorizado para executar a operação.')

class UrlNotFoundError(NetworkAPIClientError):
    
    def __init__(self, error):
        NetworkAPIClientError.__init__(self, u'Não encontrado. Uso de uma URL inválida.')
