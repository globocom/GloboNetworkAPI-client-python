...
class EquipamentoAmbiente(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(EquipamentoAmbiente, self).__init__(networkapi_url, user, password, user_ldap)
    ...
    def inserir(self, id_equipment, id_environment, is_router=0):
        ...
        code, xml = self.submit({'equipamento_ambiente':equipment_environment_map}, 'POST', 'equipamentoambiente/')
    ...
    def update(self, id_equipment, id_environment, is_router):
        ...
        code, xml = self.submit({'equipamento_ambiente':equipment_environment_map}, 'PUT', 'equipamentoambiente/update/')
