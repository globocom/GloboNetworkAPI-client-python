...
class EnvironmentVIP(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(EnvironmentVIP, self).__init__(networkapi_url, user, password, user_ldap);
    ...
    def add(self, finalidade_txt, cliente_txt, ambiente_p44_txt):
        ...
        code, xml = self.submit({'environment_vip':environmentvip_map}, 'POST', 'environmentvip/')

        return self.response(code, xml)
    
    
    def alter(self, id_environment_vip, finalidade_txt, cliente_txt, ambiente_p44_txt):
    ...
    def search(self, id_environment_vip = None, finalidade_txt = None, cliente_txt = None, ambiente_p44_txt = None):
        ...
        code, xml = self.submit({'environment_vip':environmentvip_map}, 'POST', 'environmentvip/search/')
