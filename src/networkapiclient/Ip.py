...
class Ip(GenericClient):
    ...
    def get_ipv4(self, id_ip):
        ...
        if not is_valid_int_param(id_ip):
            raise InvalidParameterError(u'The IPv4 identifier is invalid or was not informed.')
    ...
    def get_ipv6(self, id_ip):
        ...
        if not is_valid_int_param(id_ip):
            raise InvalidParameterError(u'The IPv6 identifier is invalid or was not informed.')
    ...
    def buscar_por_ip_ambiente(self, ip, id_environment):
        ...
        if not is_valid_int_param(id_environment):
            raise InvalidParameterError(u'Environment identifier is invalid or was not informed.')
    ...
    def get_available_ip4(self, id_network):
        ...
        if not is_valid_int_param(id_network):
            raise InvalidParameterError(u'Network identifier is invalid or was not informed.')
    ...
    def get_available_ip6(self, id_network6):
        ...
        if not is_valid_int_param(id_network6):
            raise InvalidParameterError(u'Network ipv6 identifier is invalid or was not informed.')
    ...
    def get_available_ip6_for_vip(self, id_evip, name):
        ...
        if not is_valid_int_param(id_evip):
            raise InvalidParameterError(u'Vip environment identifier is invalid or was not informed.')
    ...
    def edit_ipv4(self, ip4, descricao, id_ip):
        ...
        if ip4 is None or ip4 == "":
            raise InvalidParameterError(u'The IP4 is invalid or was not informed.')
    ...
    def save_ipv4(self, ip4, id_equip, descricao, id_net):
        ...
        if not is_valid_int_param(id_equip):
            raise InvalidParameterError(u'Equipment identifier is invalid or was not informed.')
    ...
    def edit_ipv6(self, ip6, descricao, id_ip):
        ...
        if not is_valid_int_param(id_ip):
            raise InvalidParameterError(u'Ipv6 identifier is invalid or was not informed.')
    ...
    def save_ipv6(self, ip6, id_equip, descricao, id_net):
        ...
        if ip6 is None or ip6 == "":
            raise InvalidParameterError(u'IPv6 is invalid or was not informed.')
    ...
    def search_ipv6_environment(self, ipv6, id_environment):
        ...
        code, xml = self.submit({'ipv6_map':ipv6_map}, 'POST', 'ipv6/environment/')
