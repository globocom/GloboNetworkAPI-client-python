...
class GrupoVirtual(GenericClient):
    def __init__(self, networkapi_url, user, password, user_ldap=None):
        ...
        """
        super(GrupoVirtual, self).__init__(networkapi_url, user, password, user_ldap);
    ...
    def provisionar(self, equipamentos, vips):
        ...
        """
        code, map = self.submit({'equipamentos':{'equipamento':equipamentos}, 'vips':{'vip':vips}}, 'POST', 'grupovirtual/')
